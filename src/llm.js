...
function buildSearchFactsTool(settings) {
  ...
  function: {
    name: 'search_facts',
    description: `Verify a specific factual claim before answering. Key-free sources include Wikipedia, Wikidata, SEC EDGAR, Federal Register, OpenAlex, Crossref, arXiv, PubMed, World Bank, GDELT, Open-Meteo, REST Countries, OpenStreetMap Nominatim, CoinGecko, Frankfurter, GitHub, npm, PyPI, endoflife.date, OSV.dev, Stack Exchange, AWS Pricing, IETF Datatracker, RFC Editor, US Bureau of Labor Statistics, Our World in Data, Wayback Machine, and Hacker News. Live sources currently available: ${sources}. Prefer package registries then GitHub for libraries, GitHub then Hacker News for repos, endoflife.date for support dates, OSV.dev for vulnerabilities, Stack Exchange for technical consensus, AWS Pricing for cloud costs, IETF/RFC Editor for standards, BLS for US labour data, and Our World in Data for global statistics. The result always names its source for citation.`,
    parameters: {
      type: 'object',
